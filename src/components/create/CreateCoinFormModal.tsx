          ...
          {onClose => (
            <>
              ...
              <ModalFooter className="flex-col laptop:flex-row justify-center gap-x-2 mb-2">
                <button
                  onClick={onClose}
                  className="bg-primary h-10 w-full laptop:w-48 rounded-3xl text-lg text-dark font-quatroBold hover:bg-[#29ff93] transition"
                >
                  SAVE
                </button>
                <button
                  ...
                  className="bg-cream/80 h-10 w-full laptop:w-48 rounded-3xl text-lg text-dark font-quatroBold hover:bg-cream transition"
                >
                  CANCEL
                </button>
              </ModalFooter>
